...
static INPUT_PORTS_START( marywu )
	...
	PORT_START("P1")
    PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYPAD) PORT_NAME("P1.6") PORT_CODE(KEYCODE_C) // Hopper? Error 30 if IP_ACTIVE_LOW.
    PORT_BIT(0x80, IP_ACTIVE_LOW,  IPT_KEYPAD) PORT_NAME("P1.7") PORT_CODE(KEYCODE_V) //  Will cause Error 76 if press.
INPUT_PORTS_END
